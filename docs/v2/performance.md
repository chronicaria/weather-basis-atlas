...
The final research-link presentation correction received a separate fresh seal: 343.72 seconds, 421,707,776-byte process peak RSS, and 749,244,937 served bytes. Its scientific inputs match the prior accepted candidate exactly; [the published seal](../../results/v2/validation/published-release.json) records that assertion.
